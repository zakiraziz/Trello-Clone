        ...
        <div className="flex gap-4 overflow-x-auto pb-4">
          ...
          {!isAddingList ? (
            <button
              ...
              className="w-80 shrink-0 bg-gray-200/50 dark:bg-gray-800/50 rounded-lg p-3 hover:bg-gray-200 dark:hover:bg-gray-800 transition-colors flex items-center gap-2 self-start"
