...
CREATE TABLE users (
    ...
    notification_settings JSONB DEFAULT '{"email": {"welcome": true, "login_alert": true, "password_reset": true, "board_invite": true, "task_assigned": true, "mention": true, "due_date_reminder": true}, "in_app": true}',
